...
if remove_title in books_list:
    ...
    if remove_author not in books_dict.values(): #Check if the author has any other vooks in the dictionary
        authors_set.remove(remove_author)

    print("Book removed successfully!")
    print("Books available alog with their authors: ", books_dict)
